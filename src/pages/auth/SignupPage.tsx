...
const SignupPage = () => {
  ...
  const handleSignup = async (e) => {
    ...
    setError(null);
    try {
      signInWithEmailPass({ email, password, name });
    } catch (err) {
    ...
    return (
      ...
      >
        <div className="text-center p-4">
          ...
          <p className="text-lg text-gray-800 dark:text-gray-200">{t("loading_")}</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div
      className="flex justify-end items-center min-h-screen bg-cover bg-center relative transition-colors duration-200 p-10 pr-20"
      style={{
    ...
    >
      ...
      <div className="absolute inset-0 bg-black bg-opacity-60 dark:bg-opacity-75" aria-hidden="true"></div>
      ...
      <div className="relative z-10 w-full max-w-md p-6 md:p-8 bg-white dark:bg-gray-800 rounded-2xl shadow-xl transition-colors duration-200 mr-10">
        ...
        >
          ...
          >
            {isPending || loading ? t("signing_up") : t("sign_up")}
          </Button>

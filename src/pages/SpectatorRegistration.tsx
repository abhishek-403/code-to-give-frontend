  ...
  return (
    <div className="p-6 max-w-2xl mx-auto">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold mb-4">{t("spectator_registration")}</h1>
        <p className="text-gray-600">{t(
          "fill_out_the_form_below_to_register_as_a_spectator_for_this_event_required_fields_are_marked_with_an_asterisk_"
        )}</p>
      </div>
      <form
